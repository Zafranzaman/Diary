...
class TestSaveViewController: UIViewController {
        ...
        override func viewDidLoad() {
            ...
            let query = "CREATE TABLE IF NOT EXISTS TestSave (tid INTEGER PRIMARY KEY AUTOINCREMENT,Name TEXT,Date TEXT, Event TEXT)"
        ...
        @IBAction func saveButtonPressed(_ sender: UIButton) {
            ...
            let query = "INSERT INTO TestSave (Name, Date, Event) VALUES ('\(txtName.text ?? "empty")', '\(dateString)','\(Event.text ?? "Other")')"
